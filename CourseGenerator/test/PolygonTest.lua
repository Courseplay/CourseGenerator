...
function testPolygon()
    ...
    local function assertGoAroundTop(line)
        ...
        line[2]:assertAlmostEquals(cg.Vector(-10, 8)) -- intersection
    ...
    local v, d, dFromEdge = p:findClosestVertexToPoint(cg.Vector(2, 6))
    v:assertAlmostEquals(cg.Vector(0, 5))
    lu.assertAlmostEquals(d, 2.236)
    lu.assertAlmostEquals(dFromEdge, 1)
    v, d, dFromEdge = p:findClosestVertexToPoint(cg.Vector(2, 4))
    lu.assertAlmostEquals(d, 2.236)
    lu.assertAlmostEquals(dFromEdge, 1)
    v, d, dFromEdge = p:findClosestVertexToPoint(cg.Vector(-2, 4))
    lu.assertAlmostEquals(d, 2.236)
    lu.assertAlmostEquals(dFromEdge, 1)
    v, d, dFromEdge = p:findClosestVertexToPoint(cg.Vector(0, 3))
    v:assertAlmostEquals(cg.Vector(0, 5))
